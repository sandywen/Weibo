...
public class Gupiao {
     ...
     Mapper<Object, Text, Text, Text> {
		 ...
		 public void map(Object key, Text value,
		     ...
		     String content     = "";
		     if(WeiboInfo[4].equals("0") && (WeiboInfo[9].indexOf("股票") != -1 )){
		    	 content = "1	0";
		     }
		     if(WeiboInfo[4].equals("1") && (WeiboInfo[14].indexOf("股票") != -1 )){
		    	 content = "0	1";
		     }
	  ...
	  public static void main(String[] args) throws Exception {
	        ...
	        Path tmpDir = new Path("/gupiaoEvent1");
	        ...
	        FileOutputFormat.setOutputPath(conf1, new Path("/gupiaoEvent2"));
