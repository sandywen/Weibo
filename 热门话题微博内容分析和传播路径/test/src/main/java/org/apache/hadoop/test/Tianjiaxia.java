...
public class Tianjiaxia {
     ...
     Mapper<Object, Text, Text, Text> {
		 ...
		 public void map(Object key, Text value,
		     ...
		     String content     = "";
		     if(WeiboInfo[4].equals("0") && (WeiboInfo[9].indexOf("青岛天价虾") != -1
		    		 || WeiboInfo[9].indexOf("天价虾") != -1)){
		    	 content = "1	0";
		     }
		     if(WeiboInfo[4].equals("1") && (WeiboInfo[14].indexOf("青岛天价虾") != -1
		    		 || WeiboInfo[14].indexOf("天价虾") != -1)){
		    	 content = "0	1";
		     }
	  ...
	  public static void main(String[] args) throws Exception {
	        ...
	        Path tmpDir = new Path("/tianjiaxiaEvent1");
	        ...
	        FileOutputFormat.setOutputPath(conf1, new Path("/tianjiaxiaEvent2"));
