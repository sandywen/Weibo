...
public class LangyabangEvent {
     ...
     Mapper<Object, Text, Text, Text> {
		 ...
		 public void map(Object key, Text value,
		     ...
		     String content     = "";
		     if(WeiboInfo[4].equals("0") && (WeiboInfo[9].indexOf("琅琊榜") != -1 
		    		 || WeiboInfo[9].indexOf("梅长苏") !=-1 || WeiboInfo[9].indexOf("林殊") !=-1  
		    		 || WeiboInfo[9].indexOf("苏先生") !=-1 || WeiboInfo[9].indexOf("飞流") !=-1
		    		 || WeiboInfo[9].indexOf("靖王") !=-1  || WeiboInfo[9].indexOf("宫羽") !=-1
		    		 || WeiboInfo[9].indexOf("静妃") !=-1  || WeiboInfo[9].indexOf("霓凰") !=-1
		    		 || WeiboInfo[9].indexOf("蔺晨") !=-1)){
		    	 content = "1	0";
		     }
		     if(WeiboInfo[4].equals("1") && (WeiboInfo[14].indexOf("琅琊榜") != -1 
		    		 || WeiboInfo[14].indexOf("梅长苏") !=-1 || WeiboInfo[14].indexOf("林殊") !=-1  
		    		 || WeiboInfo[14].indexOf("苏先生") !=-1 || WeiboInfo[14].indexOf("飞流") !=-1
		    		 || WeiboInfo[14].indexOf("靖王") !=-1  || WeiboInfo[14].indexOf("宫羽") !=-1
		    		 || WeiboInfo[14].indexOf("静妃") !=-1  || WeiboInfo[14].indexOf("霓凰") !=-1
		    		 || WeiboInfo[14].indexOf("蔺晨") !=-1)){
		    	 content = "0	1";
		     }
	  ...
	  public static void main(String[] args) throws Exception {
		  JobConf conf = new JobConf(DataCleaning.class);
	        ...
	        Path tmpDir = new Path("/langyabangEvent1");
	        ...
	        FileOutputFormat.setOutputPath(conf1, new Path("/langyabangEvent2"));
