...
public class Taobao {
     ...
     Mapper<Object, Text, Text, Text> {
		 ...
		 public void map(Object key, Text value,
		     ...
		     String content     = "";
		     if(WeiboInfo[4].equals("0") && (WeiboInfo[9].indexOf("淘宝") != -1 
		    		 || WeiboInfo[9].indexOf("某宝") !=-1)){
		    	 content = "1	0";
		     }
		     if(WeiboInfo[4].equals("1") && (WeiboInfo[14].indexOf("淘宝") != -1 
		    		 || WeiboInfo[14].indexOf("某宝") !=-1 )){
		    	 content = "0	1";
		     }
	  ...
	  public static void main(String[] args) throws Exception {
	        ...
	        Path tmpDir = new Path("/taobaoEvent1");
	        ...
	        FileOutputFormat.setOutputPath(conf1, new Path("/taobaoEvent2"));
