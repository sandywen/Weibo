...
var LineChart = function( options ) {
  ...
  var canvas = document.getElementById( 'testChart' ).appendChild(document.createElement('canvas'));
...
var panelBody = document.getElementById('panel_body');
  ...
  var rendering = false,
      paddingX = 40,
      paddingY = 40,
      width = options.width || window.innerWidth/1.222,
      height = options.height || window.innerHeight/2,
      
      progress = 0;
  //panelBody.style.width = window.innerWidth;
  canvas.width = width;
...
var initData = [
    { label: 'One', value: 0 ,future:true},
    { label: 'Two', value: 100,future:true },
    { label: 'Three', value: 200,future:true },
    { label: 'Four', value: 840 ,future:true},
    { label: 'Five', value: 620 ,future:true},
    { label: 'Six', value: 500 ,future:true},
    { label: 'Seven', value: 600 ,future:true},
    { label: 'Eight', value: 1100 ,future:true},
    { label: 'Nine', value: 800 ,future:true},
    { label: 'Ten', value: 900 ,future:true},
